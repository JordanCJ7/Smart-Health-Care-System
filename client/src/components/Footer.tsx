    ...
    <footer className="bg-gray-900 text-white mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-lg font-semibold mb-4">Smart Health Care System</h3>
            <p className="text-gray-400 text-sm">
              Your trusted partner in digital healthcare. Providing accessible, efficient, 
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="mailto:support@smarthealthcare.com" className="text-gray-400 hover:text-white transition-colors">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="text-sm text-gray-400 mb-4 md:mb-0">
              &copy; 2025 Smart Health Care System. All rights reserved.
            </div>
